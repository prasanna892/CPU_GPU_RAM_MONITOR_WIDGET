...
class SysInfo(QWidget):
    def __init__(self, parent = None):
        ...
        self.label1_pos = -55 if self.gpu else -195 # set label1 positon according to GPU
        self.radius = 10
...
##################
    ...
    def wheelEvent(self, event):
        ...
        self.scroll_label(self.pos_) # scroll info label
...
def set_wd():
	...
	# key value is Software\Microsoft\Windows\CurrentVersion\App Paths\tempInfo.exe
    path = reg.HKEY_CURRENT_USER
    app_path = r"Software\Microsoft\Windows\CurrentVersion\App Paths\tempInfo.exe"
